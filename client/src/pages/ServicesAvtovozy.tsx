...
const steps = [
  ...
  { num: "02", title: "Договор и страхование", desc: "Заключаем договор: стоимость фиксируется после проверки деталей. Страхование оформляется по условиям договора." },
  ...
  { num: "04", title: "Перевозка и сопровождение", desc: "Сопровождаем перевозку до выдачи и держим связь на всём маршруте — вы знаете статус доставки." },
  { num: "05", title: "Сдача и акт", desc: "При получении составляем акт сдачи с фотофиксацией. Страхование и ответственность действуют по условиям договора." },
];
...
const faq = [
  ...
  { q: "Что такое автовоз Lohr?", a: "Lohr — ведущий европейский производитель автовозов. Их отличительная черта — гидравлические платформы, которые позволяют погружать автомобили с минимальным клиренсом без риска повреждений. Перевозчики, с которыми мы работаем, используют автовозы Lohr и аналогичные современные платформы." },
  { q: "Что если автомобиль будет повреждён?", a: "Перевозка оформляется с договором и страхованием по его условиям. При приёмке и сдаче составляется акт осмотра с фотофиксацией. Порядок и размер возмещения определяются условиями договора и страхования." },
  { q: "Как долго идёт перевозка?", a: "Сроки зависят от маршрута и загрузки. Ориентировочно: Москва — Краснодар 2–3 дня, Москва — Новосибирск 5–7 дней, Москва — Владивосток 14–18 дней. Сроки рассчитываются предварительно и подтверждаются после проверки деталей." },
        ...
        <div className="container" style={{ position: "relative", zIndex: 1, paddingTop: "140px", paddingBottom: "5rem" }}>
          ...
          >
            ...
            <p style={{ color: "#C9D4E3", fontSize: "clamp(0.9375rem, 1.5vw, 1.0625rem)", lineHeight: 1.7, marginBottom: "1.5rem", maxWidth: "560px" }}>
              Подбираем автовоз под маршрут и автомобиль среди более 30 проверенных перевозчиков-партнёров, с которыми работаем на особых условиях. Современные платформы (включая Lohr), бережная погрузка, страхование по договору, сопровождение до выдачи.
            </p>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem" }}>
              {["Автовозы с платформами", "Страхование по договору", "Сопровождение до выдачи", "Договор"].map((badge) => (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "3rem" }} className="lg:grid-cols-2">
              ...
              <div style={{ padding: "2rem", backgroundColor: "#1C2028", border: "1px solid rgba(79, 209, 255, 0.15)", borderRadius: "0.5rem" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
                  ...
                  <div>
                    <div className="label-mono" style={{ marginBottom: "0.25rem" }}>Автопарк перевозчиков</div>
                ...
                <p style={{ color: "#C9D4E3", fontSize: "0.9375rem", lineHeight: 1.7, marginBottom: "1.25rem" }}>
                  Перевозчики, с которыми мы работаем, используют европейские автовозы Lohr с гидравлическими платформами — стандарт безопасной перевозки автомобилей. Гидравлика позволяет погружать автомобили с минимальным клиренсом без риска повреждений.
                </p>
