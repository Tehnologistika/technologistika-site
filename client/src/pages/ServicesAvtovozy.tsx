...
const steps = [
  { num: "01", title: "Заявка и расчёт", desc: "Оставьте заявку онлайн или позвоните. Менеджер перезвонит в течение 15 минут и назовёт точную стоимость." },
...
const faq = [
  ...
  { q: "Как рассчитывается стоимость?", a: "Стоимость зависит от маршрута (расстояния), типа автомобиля и срочности. Заполните форму расчёта — менеджер назовёт точную цену в течение 15 минут. Цена фиксируется в договоре и не меняется." },
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <h2 className="display-md" style={{ color: "#F5F7FA", marginBottom: "1.25rem" }}>
                Рассчитайте стоимость<br />перевозки автовозом
              </h2>
              <p style={{ color: "#AAB3C2", fontSize: "1rem", lineHeight: 1.65, marginBottom: "1.5rem" }}>
                Укажите маршрут и тип автомобиля — менеджер перезвонит в течение 15 минут с точной ценой. Цена фиксируется в договоре.
              </p>
