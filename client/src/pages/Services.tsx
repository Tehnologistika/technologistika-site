...
const services = [
  {
    ...
    desc: "Подбираем автовоз под маршрут и автомобиль среди более 30 проверенных перевозчиков-партнёров, с которыми работаем на особых условиях. Современные платформы (включая Lohr), бережная погрузка, надёжная фиксация, страхование по договору.",
    features: ["Современные автовозы с гидравлическими платформами", "Более 30 проверенных перевозчиков", "Страхование — по условиям договора", "Сопровождение перевозки до выдачи", "Акт осмотра с фотофиксацией"],
  ...
  },
  {
    ...
    desc: "Доставка автомобилей между городами России. Сроки рассчитываем предварительно и подтверждаем после проверки деталей. Более 50 городов в нашей сети — от Москвы и Санкт-Петербурга до Краснодара, Екатеринбурга, Новосибирска и Владивостока.",
    features: ["50+ городов России", "Предварительный расчёт сроков", "Страхование по договору", "Персональный менеджер", "Стоимость фиксируется в договоре"],
    href: "/services",
    featured: false,
  },
  {
    ...
    features: ["Казахстан, Беларусь, другие страны СНГ", "Таможенное сопровождение", "Помощь с документами", "Страхование по условиям договора", "Опытные водители"],
    href: "/services",
    featured: false,
  },
  {
        ...
        <div className="container">
          ...
          >
            ...
            <p style={{ color: "#AAB3C2", fontSize: "1.0625rem", lineHeight: 1.7, maxWidth: "560px" }}>
              Для частных клиентов, автосалонов, импортёров и крупного бизнеса — мы перевозим любые автомобили по всей России и СНГ: договор, фотофиксация по этапам и сопровождение до выдачи.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ paddingTop: "4rem", paddingBottom: "4rem", backgroundColor: "#161A20", borderTop: "1px solid rgba(255,255,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(1, 1fr)", gap: "1.5rem" }} className="sm:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: <Shield size={20} style={{ color: "#4FD1FF" }} />, title: "Страхование", desc: "по условиям договора" },
              { icon: <Clock size={20} style={{ color: "#4FD1FF" }} />, title: "Прозрачные сроки", desc: "предварительный расчёт" },
              { icon: <MapPin size={20} style={{ color: "#4FD1FF" }} />, title: "Сопровождение", desc: "до выдачи авто" },
              { icon: <Truck size={20} style={{ color: "#4FD1FF" }} />, title: "Проверенные перевозчики", desc: "автовоз под маршрут" },
            ].map((item, i) => (
